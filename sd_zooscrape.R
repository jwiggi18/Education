...
plot(sd_phy, cex=0.2, main="San Diego Zoo Animals")
ape::axisPhylo()


pdf(file="SanDiegoZoo.pdf", width=5, height=10)
sd_phy$node.label[grepl("mrcaott", sd_phy$node.label)] <- ""
plot(sd_phy, cex=0.2, main="San Diego Zoo Animals")
nodelabels(sd_phy$node.label, frame="none", cex=0.2, col="red")
ape::axisPhylo()
dev.off()
system("open SanDiegoZoo.pdf")
